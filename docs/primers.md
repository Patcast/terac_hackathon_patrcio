# Primers — keep it simple

**Canonical iMessage copy:** [imessage_flow.md](./imessage_flow.md).

This page is the short checklist; the script page has the full bubbles.

---

## Owner lines (demo actor)
...
Max **two** dig-ins before the hard question.
...
4. Stripe link
5. Before → after after human feedback

---

## Linq polish (after basic flow; before Replay)

- 👍 on “Thanks”
- Read + typing before each Tammy reply
---
